...
# TODO(austin): Figure out how RT to be...
# TODO(austin): Figure out the loop architecture for the motors.
#   Want to be really RT on them, mostly because overkill us underrated.

class KochRealEnvironment(_environment.Environment):
    """An environment for an Koch robot on real hardware."""
    ...
    def get_observation(self) -> dict:
        ...
        result = {
            ...
            "prompt": "Load hay bales onto wagon.",
        }
