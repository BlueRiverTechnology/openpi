...
import openpi.policies.koch_policy as koch_policy
...
class LeRobotKochDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        # Convert images to uint8 numpy arrays, add masks
        data_transforms = _transforms.Group(
            inputs=[koch_policy.KochInputs(action_dim=model_config.action_dim, model_type=model_config.model_type)],
            outputs=[koch_policy.KochOutputs()],
        )
        # Use delta actions (not for gripper)
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_koch_low_mem_finetune_v116",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotKochDataConfig(
            repo_id="hay_bale/v116",
            base_config=DataConfig(
    ...
    TrainConfig(
        name="pi0_koch_low_mem_finetune_v116_100k",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotKochDataConfig(
            repo_id="hay_bale/v116",
            base_config=DataConfig(
    ...
    TrainConfig(
        name="pi0_koch_v116_fsdp_4_bs_32_100k",
        model=pi0.Pi0Config(),
        data=LeRobotKochDataConfig(
            repo_id="hay_bale/v116",
            base_config=DataConfig(
    ...
    TrainConfig(
        name="pi0_koch_v116_fsdp_4_bs_32_200k",
        model=pi0.Pi0Config(),
        data=LeRobotKochDataConfig(
            repo_id="hay_bale/v116",
            base_config=DataConfig(
    ...
    TrainConfig(
        name="pi0_koch_v116_fsdp_4_bs_32_500k",
        model=pi0.Pi0Config(),
        data=LeRobotKochDataConfig(
            repo_id="hay_bale/v116",
            base_config=DataConfig(
